        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">FinanceMentor</span>
              </div>
              <p className="text-gray-400 mb-4 max-w-md">
                Your intelligent personal finance advisor powered by AI. Transform your financial future with personalized guidance and smart insights.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2024 FinanceMentor. All rights reserved. Built with ❤️ for your financial success.
            </p>
          </div>
        </div>
      </footer>
